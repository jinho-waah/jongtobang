  ...
  const handleSocialLogin = (provider: "naver" | "kakao" | "google") => {
    ...
    switch (provider) {
      case "naver":
        ...
        // }&state=random_state`;
        authUrl = `https://jongtobang.duckdns.org/oauth2/authorization/naver`;
      ...
      case "kakao":
        ...
        authUrl = `https://jongtobang.duckdns.org/oauth2/authorization/kakao`;
        break;
      case "google":
        ...
        authUrl = `https://jongtobang.duckdns.org/oauth2/authorization/google`;
        break;
      default:
        return;
    }
